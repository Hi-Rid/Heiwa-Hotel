...
Route::group(['middleware' => ['auth', "role:user"]], function() {
    ...
    Route::get('/dashboard/roomview', 'App\Http\Controllers\DashboardController@roomview')->name('dashboard.roomview');
    Route::get('/dashboard/facilityview', 'App\Http\Controllers\DashboardController@facilityview')->name('dashboard.facilityview');
});

//auth route for receptionist
