    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.roomview')" :active="request()->routeIs('dashboard.roomview')">
                        {{ __('Room') }}
                    </x-nav-link>
                    <x-nav-link :href="route('dashboard.facilityview')" :active="request()->routeIs('dashboard.facilityview')">
                        {{ __('Facility') }}
                    </x-nav-link>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('roomtype.index')" :active="request()->routeIs('roomtype')">
                        {{ __('Room') }}
                    </x-nav-link>
